...
import {
    ...
    SelectOption,
    Text,
    TextContent, TextVariants, TextInputGroup, TextInputGroupMain, TextInputGroupUtilities,
    Button,
...
export const NavigatorCardHeader = ({
    currentFilter, setCurrentFilter, onFilterChange, isGrid, setIsGrid, sortBy,
    setSortBy
}) => {
    return (
