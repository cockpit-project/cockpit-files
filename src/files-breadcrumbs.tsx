...
function BookmarkButton({ path }: { path: string[] }) {
    ...
    const [bookmarkHandle, setBookmarkHandle] =
        React.useState<cockpit.FileHandle<string> | null>(null);
        ...
        >
            <DropdownList>
                {defaultBookmarks.map((defaultBookmark) => (
                    <DropdownItem
                        key={defaultBookmark.loc}
                        value={defaultBookmark.loc}
                    >
                        {defaultBookmark.name}
                    </DropdownItem>
                ))}
                {bookmarks.length !== 0 && <Divider key="bookmark-divider" />}
        ...
        <PageBreadcrumb stickyOnBreakpoint={{ default: "top" }}>
            <Flex spaceItems={{ default: "spaceItemsSm" }}>
                    ...
                    fullPath.map((dir, i) => {
                        return (
                            ...
                            >
                                ...
                                {dir !== "" && (
                                    <p className="path-divider" key={i}>
                                        /
                                    </p>
                                )}
                            </React.Fragment>
                ...
                <FlexItem align={{ default: "alignRight" }}>
                    {editMode && (
                        <>
                            <Button
                                variant="plain"
                                icon={
                                    <CheckIcon className="breadcrumb-edit-apply-icon" />
                                }
                                onClick={changePath}
                    ...
                    <KebabDropdown
                        toggleButtonId="global-settings-menu"
                        dropdownItems={[
                            <DropdownItem
